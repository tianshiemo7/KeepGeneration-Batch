...
class KeepSultanApp:
    ...
    def process(self) -> Image.Image:
        ...
        # 5) 文本绘制（坐标与字体取自原始脚本）
        # 左上角状态栏时间：优先用 status_bar_time，否则用 end_time
        status_bar = getattr(self.cfg, 'status_bar_time', None) or end_time
        self.editor.draw_text(status_bar[:5], (50, 25), self.cfg.font_clock)  # 系统时间 HH:MM
